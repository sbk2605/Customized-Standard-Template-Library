...
void man(char *name)
{
	...
	{
		printf("Description : Used to display information from file\n");
	...
	else if(strcmp(name,"lseek") == 0)
	{
		...
		printf("Usage : lseek File_name changeInOffset StartPoibt\n");
	}
...
void DisplayHelp()
{
	...
	printf("open : To close the file\n");
	printf("close : To close the file\n");
	printf("closeall : To close all opened file\n");
	printf("read : To read the contents \n");
	...
	while(1)
	{
		...
		else if(count == 3)
		{
			if(strcmp(command[0],"create") == 0)
			{
				...
				if(ret >= 0)
					printf("File is successfully created with file desiptor : %d\n", ret);
				if(ret == -1)
					printf("ERROR : Incorrect parameters\n");
				if(ret == -2)
			...
			else if(strcmp(command[0],"open") == 0)
			{
				...
				if(ret >= 0)
					printf("File is successfully opened with file desiptor : %d\n",ret);
				if(ret == -1)
					printf("ERROR : Incorrect parameters\n");
				if(ret == -2)
